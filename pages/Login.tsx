    ...
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col items-center py-12 px-4 overflow-x-hidden relative">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="w-full max-w-md mx-auto bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/50 p-10 border border-slate-100 relative overflow-hidden order-2 lg:order-1">
          ...
          {error && (
            <div className={`mb-8 p-5 border rounded-2xl flex flex-col gap-3 animate-shake shadow-sm ${
              ...
              {error.isCredentialError && mode === 'login' && (
                <button 
                   ...
                   className="text-[10px] font-black uppercase tracking-widest bg-red-600 text-white px-4 py-2 rounded-xl self-start hover:bg-red-700 transition-colors"
                >
          ...
          <form onSubmit={handleAuth} className="space-y-6">
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full ${isRtl ? 'pr-12 pl-4' : 'pl-12 pr-4'} py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all text-black font-semibold`}
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full ${isRtl ? 'pr-12 pl-12' : 'pl-12 pr-12'} py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all text-black font-semibold`}
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-3 transition-all shadow-xl active:scale-[0.98]"
            >
          ...
          <div className="bg-white rounded-[2.5rem] p-8 border-4 border-amber-100 shadow-2xl relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <div className="grid gap-8">
                {[
                  { title: isRtl ? 'ضمان الجودة' : 'Quality Assurance', desc: isRtl ? 'نتحقق من كل منتج.' : 'We check every item.' },
                  { title: isRtl ? 'دفع آمن' : 'Safe Payment', desc: isRtl ? 'أموالك في أمان.' : 'Your money is safe.' }
                ].map((item, i) => (
